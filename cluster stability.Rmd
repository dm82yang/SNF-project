...
var_metabo <- apply(Data_metabo, 2, var)
var_metabo <- sort(var_metabo,decreasing = TRUE)

# set a threshold of variance (look at feature numbers)
var_metabo <- var_metabo[var_metabo>1]
# feature selection
selected_features<-attr(var_metabo, "names")
Data_metabo <- Data_metabo[,(colnames(Data_metabo) %in% selected_features)]
